...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v2/items/{collection}": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "CreateItemsRequestBody",
                        "name": "object",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "DeleteManyItemRequestBody",
                        "name": "object",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "patch": {
                ...
                "operationId": "multiple_update_items",
                "parameters": [
                    {
                        "type": "string",
                        "description": "collection",
                    ...
                    {
                        "description": "MultipleItemsRequesUpdatetBody",
                        "name": "items",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.MultipleUpdateItems"
                        }
                    }
                ],
                "responses": {
        ...
        "/v2/items/{collection}/aggregation": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "get_list_aggregation",
                "parameters": [
                    {
                        "type": "string",
                        "description": "collection",
        ...
        "/v2/items/{collection}/multiple-insert": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.MultipleInsertItems"
                        }
                    }
                ],
                "responses": {
        ...
        "/v2/items/{collection}/upsert-many": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "UpsertManyItemsRequestBody",
                        "name": "object",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "models.FileDeleteRequest": {
            ...
            "properties": {
                "objects": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.FileDelete"
                    }
                }
            }
        },
